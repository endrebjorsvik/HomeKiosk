...
void OAIProject::fromJsonObject(QJsonObject json) {
    ...
    m_sensor_count_isSet = !json[QString("sensorCount")].isNull() && m_sensor_count_isValid;

    m_cloud_connector_count_isValid = ::OpenAPI::fromJsonValue(cloud_connector_count, json[QString("cloudConnectorCount")]);
    m_cloud_connector_count_isSet = !json[QString("cloudConnectorCount")].isNull() && m_cloud_connector_count_isValid;
}
...
bool OAIProject::isInventory() const {
    return inventory;
}
void OAIProject::setInventory(const bool &inventory) {
    this->inventory = inventory;
    this->m_inventory_isSet = true;
}

QString OAIProject::getOrganization() const {
    return organization;
}
void OAIProject::setOrganization(const QString &organization) {
    this->organization = organization;
    this->m_organization_isSet = true;
}

QString OAIProject::getOrganizationDisplayName() const {
    return organization_display_name;
}
void OAIProject::setOrganizationDisplayName(const QString &organization_display_name) {
    this->organization_display_name = organization_display_name;
    this->m_organization_display_name_isSet = true;
}

qint32 OAIProject::getSensorCount() const {
    return sensor_count;
}
void OAIProject::setSensorCount(const qint32 &sensor_count) {
    this->sensor_count = sensor_count;
    this->m_sensor_count_isSet = true;
}

qint32 OAIProject::getCloudConnectorCount() const {
    return cloud_connector_count;
}
void OAIProject::setCloudConnectorCount(const qint32 &cloud_connector_count) {
