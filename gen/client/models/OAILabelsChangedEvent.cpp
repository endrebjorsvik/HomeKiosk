...
void OAILabelsChangedEvent::initializeModel() {
...
void OAILabelsChangedEvent::fromJson(QString jsonString) {
...
void OAILabelsChangedEvent::fromJsonObject(QJsonObject json) {
...
QString OAILabelsChangedEvent::asJson() const {
...
QJsonObject OAILabelsChangedEvent::asJsonObject() const {
    QJsonObject obj;
    if (added.size() > 0) {
...
QMap<QString, QString> OAILabelsChangedEvent::getAdded() const {
    return added;
}
void OAILabelsChangedEvent::setAdded(const QMap<QString, QString> &added) {
    this->added = added;
    this->m_added_isSet = true;
}

QMap<QString, QString> OAILabelsChangedEvent::getModified() const {
    return modified;
}
void OAILabelsChangedEvent::setModified(const QMap<QString, QString> &modified) {
    this->modified = modified;
    this->m_modified_isSet = true;
}

QList<QString> OAILabelsChangedEvent::getRemoved() const {
    return removed;
}
void OAILabelsChangedEvent::setRemoved(const QList<QString> &removed) {
    this->removed = removed;
    this->m_removed_isSet = true;
}

bool OAILabelsChangedEvent::isSet() const {
...
bool OAILabelsChangedEvent::isValid() const {
