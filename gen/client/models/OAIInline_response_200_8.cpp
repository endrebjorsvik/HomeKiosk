...
QList<OAIOrganization> OAIInline_response_200_8::getOrganizations() const {
    return organizations;
}
void OAIInline_response_200_8::setOrganizations(const QList<OAIOrganization> &organizations) {
    this->organizations = organizations;
    this->m_organizations_isSet = true;
}

QString OAIInline_response_200_8::getNextPageToken() const {
    return next_page_token;
}
void OAIInline_response_200_8::setNextPageToken(const QString &next_page_token) {
