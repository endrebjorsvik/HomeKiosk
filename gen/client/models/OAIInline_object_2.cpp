...
QList<QString> OAIInline_object_2::getRoles() const {
    return roles;
}
void OAIInline_object_2::setRoles(const QList<QString> &roles) {
    this->roles = roles;
    this->m_roles_isSet = true;
}

QString OAIInline_object_2::getEmail() const {
    return email;
}
void OAIInline_object_2::setEmail(const QString &email) {
    this->email = email;
