...
QList<OAIMember> OAIInline_response_200_9::getOrganizations() const {
    return organizations;
}
void OAIInline_response_200_9::setOrganizations(const QList<OAIMember> &organizations) {
    this->organizations = organizations;
    this->m_organizations_isSet = true;
}

QString OAIInline_response_200_9::getNextPageToken() const {
    return next_page_token;
}
void OAIInline_response_200_9::setNextPageToken(const QString &next_page_token) {
