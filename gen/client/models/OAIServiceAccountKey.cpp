...
QString OAIServiceAccountKey::getName() const {
    return name;
}
void OAIServiceAccountKey::setName(const QString &name) {
    this->name = name;
...
QDateTime OAIServiceAccountKey::getCreateTime() const {
    return create_time;
}
void OAIServiceAccountKey::setCreateTime(const QDateTime &create_time) {
