...
void OAIDataConnectorMetrics::initializeModel() {
...
void OAIDataConnectorMetrics::fromJson(QString jsonString) {
...
void OAIDataConnectorMetrics::fromJsonObject(QJsonObject json) {
    ...
    m_latency99p_isSet = !json[QString("latency99p")].isNull() && m_latency99p_isValid;
}

QString OAIDataConnectorMetrics::asJson() const {
...
QJsonObject OAIDataConnectorMetrics::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIDataConnectorMetrics::getSuccessCount() const {
    return success_count;
}
void OAIDataConnectorMetrics::setSuccessCount(const qint32 &success_count) {
    this->success_count = success_count;
    this->m_success_count_isSet = true;
}

qint32 OAIDataConnectorMetrics::getErrorCount() const {
    return error_count;
}
void OAIDataConnectorMetrics::setErrorCount(const qint32 &error_count) {
    this->error_count = error_count;
    this->m_error_count_isSet = true;
}

QString OAIDataConnectorMetrics::getLatency99p() const {
    return latency99p;
}
void OAIDataConnectorMetrics::setLatency99p(const QString &latency99p) {
    this->latency99p = latency99p;
    this->m_latency99p_isSet = true;
}

bool OAIDataConnectorMetrics::isSet() const {
...
bool OAIDataConnectorMetrics::isValid() const {
