...
QList<OAIRole> OAIMember::getRoles() const {
    return roles;
}
void OAIMember::setRoles(const QList<OAIRole> &roles) {
    this->roles = roles;
    this->m_roles_isSet = true;
}

QString OAIMember::getMembershipStatus() const {
    return membership_status;
}
void OAIMember::setMembershipStatus(const QString &membership_status) {
...
QString OAIMember::getAccountType() const {
    return account_type;
}
void OAIMember::setAccountType(const QString &account_type) {
