...
void
OAIBatteryStatus::fromJson(QString jsonString) {
...
void
OAIBatteryStatus::fromJsonObject(QJsonObject json) {
...
QJsonObject
OAIBatteryStatus::asJsonObject() const {
    QJsonObject obj;
...
qint32
OAIBatteryStatus::getPercentage() const {
    return percentage;
}
void
OAIBatteryStatus::setPercentage(const qint32 &percentage) {
...
QDateTime
OAIBatteryStatus::getUpdateTime() const {
    return update_time;
}
void
OAIBatteryStatus::setUpdateTime(const QDateTime &update_time) {
    this->update_time = update_time;
    this->m_update_time_isSet = true;
}

bool
OAIBatteryStatus::isSet() const {
    bool isObjectUpdated = false;
    do{ 
        if(m_percentage_isSet){ isObjectUpdated = true; break;}
...
bool
OAIBatteryStatus::isValid() const {
