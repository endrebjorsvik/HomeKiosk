...
void OAIInline_response_200_1::fromJsonObject(QJsonObject json) {
    ...
    m_batch_errors_isSet = !json[QString("batchErrors")].isNull() && m_batch_errors_isValid;
}
...
QList<OAIInline_response_200_1_batchErrors> OAIInline_response_200_1::getBatchErrors() const {
    return batch_errors;
}
void OAIInline_response_200_1::setBatchErrors(const QList<OAIInline_response_200_1_batchErrors> &batch_errors) {
