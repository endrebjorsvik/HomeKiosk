...
QList<OAIServiceAccount> OAIInline_response_200_12::getServiceAccounts() const {
    return service_accounts;
}
void OAIInline_response_200_12::setServiceAccounts(const QList<OAIServiceAccount> &service_accounts) {
    this->service_accounts = service_accounts;
    this->m_service_accounts_isSet = true;
}

QString OAIInline_response_200_12::getNextPageToken() const {
    return next_page_token;
}
void OAIInline_response_200_12::setNextPageToken(const QString &next_page_token) {
