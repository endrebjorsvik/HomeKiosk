...
QString OAIEthernetStatus::getMacAddress() const {
    return mac_address;
}
void OAIEthernetStatus::setMacAddress(const QString &mac_address) {
...
QList<OAIErrorMessage> OAIEthernetStatus::getErrors() const {
    return errors;
}
void OAIEthernetStatus::setErrors(const QList<OAIErrorMessage> &errors) {
    this->errors = errors;
    this->m_errors_isSet = true;
}

QDateTime OAIEthernetStatus::getUpdateTime() const {
    return update_time;
}
void OAIEthernetStatus::setUpdateTime(const QDateTime &update_time) {
