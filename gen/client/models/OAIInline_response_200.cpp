...
QList<OAIDevice>
OAIInline_response_200::getDevices() const {
    return devices;
}
void
OAIInline_response_200::setDevices(const QList<OAIDevice> &devices) {
...
QString
OAIInline_response_200::getNextPageToken() const {
    return next_page_token;
}
void
OAIInline_response_200::setNextPageToken(const QString &next_page_token) {
