...
void
OAIDevice::fromJson(QString jsonString) {
...
void
OAIDevice::fromJsonObject(QJsonObject json) {
...
QString
OAIDevice::getName() const {
    return name;
}
void
OAIDevice::setName(const QString &name) {
    this->name = name;
...
QString
OAIDevice::getType() const {
    return type;
}
void
OAIDevice::setType(const QString &type) {
    this->type = type;
...
OAIDevice::getLabels() const {
    return labels;
}
void
OAIDevice::setLabels(const QMap<QString, QString> &labels) {
    this->labels = labels;
...
QDateTime
OAIDevice::getCreateTime() const {
    return create_time;
}
void
OAIDevice::setCreateTime(const QDateTime &create_time) {
...
QDateTime
OAIDevice::getUpdateTime() const {
    return update_time;
}
void
OAIDevice::setUpdateTime(const QDateTime &update_time) {
...
OAIDevice::getReported() const {
    return reported;
}
void
OAIDevice::setReported(const OAIAnyOfConnectionStatusEventEthernetStatusEventCellularStatusEventConnectionLatencyEventTouchEvent &reported) {
    this->reported = reported;
    this->m_reported_isSet = true;
}

bool
OAIDevice::isSet() const {
