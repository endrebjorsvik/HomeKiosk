...
void
OAICellularStatus::fromJson(QString jsonString) {
...
void
OAICellularStatus::fromJsonObject(QJsonObject json) {
...
QString
OAICellularStatus::asJson () const {
...
QJsonObject
OAICellularStatus::asJsonObject() const {
    QJsonObject obj;
...
qint32
OAICellularStatus::getSignalStrength() const {
    return signal_strength;
}
void
OAICellularStatus::setSignalStrength(const qint32 &signal_strength) {
...
OAICellularStatus::getErrors() const {
    return errors;
}
void
OAICellularStatus::setErrors(const QList<OAIErrorMessage> &errors) {
    this->errors = errors;
...
QDateTime
OAICellularStatus::getUpdateTime() const {
    return update_time;
}
void
OAICellularStatus::setUpdateTime(const QDateTime &update_time) {
    this->update_time = update_time;
    this->m_update_time_isSet = true;
}

bool
OAICellularStatus::isSet() const {
...
bool
OAICellularStatus::isValid() const {
