...
QList<OAIEvent>
OAIInline_response_200_2::getEvents() const {
    return events;
}
void
OAIInline_response_200_2::setEvents(const QList<OAIEvent> &events) {
    this->events = events;
...
QString
OAIInline_response_200_2::getNextPageToken() const {
    return next_page_token;
}
void
OAIInline_response_200_2::setNextPageToken(const QString &next_page_token) {
