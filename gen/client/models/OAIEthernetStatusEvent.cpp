...
void
OAIEthernetStatusEvent::fromJson(QString jsonString) {
...
void
OAIEthernetStatusEvent::fromJsonObject(QJsonObject json) {
...
QString
OAIEthernetStatusEvent::asJson () const {
...
QJsonObject
OAIEthernetStatusEvent::asJsonObject() const {
    QJsonObject obj;
...
OAIEthernetStatus
OAIEthernetStatusEvent::getEthernetStatus() const {
    return ethernet_status;
}
void
OAIEthernetStatusEvent::setEthernetStatus(const OAIEthernetStatus &ethernet_status) {
    this->ethernet_status = ethernet_status;
    this->m_ethernet_status_isSet = true;
}

bool
OAIEthernetStatusEvent::isSet() const {
    bool isObjectUpdated = false;
    do{ 
        if(ethernet_status.isSet()){ isObjectUpdated = true; break;}
    }while(false);
    return isObjectUpdated;
}

bool
OAIEthernetStatusEvent::isValid() const {
