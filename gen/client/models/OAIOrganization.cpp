...
void
OAIOrganization::fromJson(QString jsonString) {
...
void
OAIOrganization::fromJsonObject(QJsonObject json) {
...
QJsonObject
OAIOrganization::asJsonObject() const {
    QJsonObject obj;
	if(m_name_isSet){
...
QString
OAIOrganization::getName() const {
    return name;
}
void
OAIOrganization::setName(const QString &name) {
    this->name = name;
...
QString
OAIOrganization::getDisplayName() const {
    return display_name;
}
void
OAIOrganization::setDisplayName(const QString &display_name) {
...
QList<OAIRole>
OAIOrganization::getRoles() const {
    return roles;
}
void
OAIOrganization::setRoles(const QList<OAIRole> &roles) {
    this->roles = roles;
    this->m_roles_isSet = true;
}

bool
OAIOrganization::isSet() const {
