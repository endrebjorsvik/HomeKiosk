...
OAIDevicesApi::OAIDevicesApi() : basePath("/v2"),
...
OAIDevicesApi::OAIDevicesApi(const QString& host, const QString& basePath, const int tout) {
    this->host = host;
...
void OAIDevicesApi::setApiTimeOutMs(const int tout){
    timeout = tout;
}
...
void
OAIDevicesApi::projectsProjectDevicesDeviceGet(const QString& project, const QString& device) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/devices/{device}");
    ...
    connect(worker,
            ...
            this,
            &OAIDevicesApi::projectsProjectDevicesDeviceGetCallback);

    worker->execute(&input);
}

void
OAIDevicesApi::projectsProjectDevicesDeviceGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
...
void
OAIDevicesApi::projectsProjectDevicesDeviceLabelsLabelDelete(const QString& project, const QString& device, const QString& label) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/devices/{device}/labels/{label}");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    fullPath.replace(projectPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(project)));
    QString devicePathParam("{"); 
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDevicesApi::projectsProjectDevicesDeviceLabelsLabelDeleteCallback);

    worker->execute(&input);
}

void
OAIDevicesApi::projectsProjectDevicesDeviceLabelsLabelDeleteCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIDevicesApi::projectsProjectDevicesDeviceLabelsLabelPatch(const QString& project, const QString& device, const QString& label, const UNKNOWN_BASE_TYPE& unknown_base_type) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/devices/{device}/labels/{label}");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDevicesApi::projectsProjectDevicesDeviceLabelsLabelPatchCallback);

    worker->execute(&input);
}

void
OAIDevicesApi::projectsProjectDevicesDeviceLabelsLabelPatchCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIDevicesApi::projectsProjectDevicesDeviceLabelsPost(const QString& project, const QString& device, const UNKNOWN_BASE_TYPE& unknown_base_type) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/devices/{device}/labels");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    fullPath.replace(projectPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(project)));
    QString devicePathParam("{"); 
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDevicesApi::projectsProjectDevicesDeviceLabelsPostCallback);

    worker->execute(&input);
}

void
OAIDevicesApi::projectsProjectDevicesDeviceLabelsPostCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIDevicesApi::projectsProjectDevicesGet(const QString& project, const QString& query, const QList<QString>& device_ids, const QList<QString>& device_types, const QList<QString>& label_filters, const QString& order_by, const QString& page_size, const QString& page_token) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/devices");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    fullPath.replace(projectPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(project)));
    ...
    fullPath.append(QUrl::toPercentEncoding("order_by"))
        .append("=")
        .append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(order_by)));
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDevicesApi::projectsProjectDevicesGetCallback);

    worker->execute(&input);
}

void
OAIDevicesApi::projectsProjectDevicesGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIDevicesApi::projectsProjectDevicesbatchUpdatePost(const QString& project, const OAIInline_object& oai_inline_object) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/devices:batchUpdate");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    fullPath.replace(projectPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(project)));
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDevicesApi::projectsProjectDevicesbatchUpdatePostCallback);

    worker->execute(&input);
}

void
OAIDevicesApi::projectsProjectDevicesbatchUpdatePostCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIDevicesApi::projectsProjectDevicestransferPost(const QString& project, const OAIInline_object_1& oai_inline_object_1) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/devices:transfer");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    fullPath.replace(projectPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(project)));
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIDevicesApi::projectsProjectDevicestransferPostCallback);

    worker->execute(&input);
}

void
OAIDevicesApi::projectsProjectDevicestransferPostCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
