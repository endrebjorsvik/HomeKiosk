...
OAIServiceAccountsApi::OAIServiceAccountsApi() : basePath("/v2"),
...
OAIServiceAccountsApi::OAIServiceAccountsApi(const QString& host, const QString& basePath, const int tout) {
    this->host = host;
...
void OAIServiceAccountsApi::setApiTimeOutMs(const int tout){
    timeout = tout;
}
...
void
OAIServiceAccountsApi::projectsProjectServiceaccountsGet(const QString& project, const QString& page_size, const QString& page_token) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/serviceaccounts");
    ...
    connect(worker,
            ...
            this,
            &OAIServiceAccountsApi::projectsProjectServiceaccountsGetCallback);

    worker->execute(&input);
}

void
OAIServiceAccountsApi::projectsProjectServiceaccountsGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
...
void
OAIServiceAccountsApi::projectsProjectServiceaccountsPost(const QString& project, const UNKNOWN_BASE_TYPE& unknown_base_type) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/serviceaccounts");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIServiceAccountsApi::projectsProjectServiceaccountsPostCallback);

    worker->execute(&input);
}

void
OAIServiceAccountsApi::projectsProjectServiceaccountsPostCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountDelete(const QString& project, const QString& serviceaccount) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/serviceaccounts/{serviceaccount}");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    fullPath.replace(projectPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(project)));
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountDeleteCallback);

    worker->execute(&input);
}

void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountDeleteCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountGet(const QString& project, const QString& serviceaccount) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/serviceaccounts/{serviceaccount}");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountGetCallback);

    worker->execute(&input);
}

void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysGet(const QString& project, const QString& serviceaccount, const QString& page_size, const QString& page_token) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/serviceaccounts/{serviceaccount}/keys");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    fullPath.replace(projectPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(project)));
    QString serviceaccountPathParam("{"); 
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysGetCallback);

    worker->execute(&input);
}

void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysKeyDelete(const QString& project, const QString& serviceaccount, const QString& key) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/serviceaccounts/{serviceaccount}/keys/{key}");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    fullPath.replace(projectPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(project)));
    QString serviceaccountPathParam("{"); 
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysKeyDeleteCallback);

    worker->execute(&input);
}

void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysKeyDeleteCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysKeyGet(const QString& project, const QString& serviceaccount, const QString& key) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/serviceaccounts/{serviceaccount}/keys/{key}");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysKeyGetCallback);

    worker->execute(&input);
}

void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysKeyGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysPost(const QString& project, const QString& serviceaccount, const OAIObject& body) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/serviceaccounts/{serviceaccount}/keys");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysPostCallback);

    worker->execute(&input);
}

void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountKeysPostCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountPatch(const QString& project, const QString& serviceaccount, const QString& update_mask, const OAIServiceAccount& oai_service_account) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/projects/{project}/serviceaccounts/{serviceaccount}");
    QString projectPathParam("{"); 
    projectPathParam.append("project").append("}");
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountPatchCallback);

    worker->execute(&input);
}

void
OAIServiceAccountsApi::projectsProjectServiceaccountsServiceaccountPatchCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
